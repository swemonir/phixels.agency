      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        duration: 0.8
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button variant="primary" glow triggerPopup className="w-full sm:w-auto text-lg px-8 py-4">
        ...
        <motion.div style={{
        y: y1
      }} className="absolute bottom-32 left-[5%] hidden lg:block" whileHover={{
        scale: 1.1
      }}>
        ...
        <motion.div style={{
        y: y2
      }} className="absolute top-32 right-[5%] hidden lg:block" whileHover={{
        scale: 1.1
      }}>
